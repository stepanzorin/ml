...
void regression_metrics_s::print() const noexcept {
    std::println("MAE: {}", mae);
    std::println("MSE: {}", mse);
...
void regression_metric_records_s::print_diff() const noexcept {
    ...
    std::println("R2 [ before: {} | after: {} ]\n", first->r2_score, last->r2_score);
}

void binary_classification_metrics_s::print() const noexcept {
    std::println("Accuracy: {}", accuracy);
    std::println("Precision: {}", precision);
    std::println("Recall: {}", recall);
    std::println("F1 score: {}", f1_score);
    std::println("LogLoss: {}\n", log_loss);
}
...
void binary_classification_metric_records_s::print_diff() const noexcept {
    ...
    std::println("LogLoss [ before: {} | after: {} ]\n", first->log_loss, last->log_loss);
}
